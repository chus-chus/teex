...
if __name__ == '__main__':
    print('AUTOMATICALLY GENERATING EXPLANATIONS.')
    X, y = gen_tabular_data(explanations=None)
    print('\n', X[1:3], y[1:3])
    X, y, exp = gen_tabular_data()
    print('\n', X[1:3], y[1:3], exp[1:3])
    X, y, exp, model = gen_tabular_data(returnModel=True)
    print('\n', X[1:3], y[1:3], exp[1:3], model)

    print('\nONE CAN ALSO EXTRACT THE ORIGINAL EXPLANATIONS FROM THE MODEL:')
