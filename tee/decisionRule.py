...
from tee._baseClasses._baseClassifier import _BaseClassifier
# noinspection PyProtectedMember
from tee.utils._misc import _generate_feature_names
...
def complete_rule_quality(gts: DecisionRule, rules: DecisionRule, eps: float = 0.1) -> float:
    ...
    rule explanation amongst those that are != inf. Mathematically, given two rules :math:`e, \tilde e` and a similarity
    threshold :math:`\varepsilon`, the quality of :math:`e` with respect to :math:`\tilde e` is:
